...
import com.example.discord.model.Exception.*;
...
public class ClientRequestSender {
    ...
    public static void sendRequest(ObjectOutputStream objectOutputStream, RequestType requestType, String text, Object object) {
    ...
    public static Response receiveResponse(ObjectInputStream objectInputStream) {
